object AboutBox: TAboutBox
  ...
  object Panel1: TPanel
    ...
    object Comments: TLabel
      ...
      Width = 121
      Height = 49
      Caption = 'Copyright '#169' '#171'2024'#187' '#171#1046#1080#1083#1080#1085' '#1056#1086#1089#1090#1080#1089#1083#1072#1074' '#1056#1086#1084#1072#1085#1086#1074#1080#1095#187
      WordWrap = True
      IsControl = True
    end
  end
